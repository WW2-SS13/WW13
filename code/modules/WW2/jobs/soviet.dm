...
/datum/job/soviet/partisan/commander
	title = "Soviet Partisan Commander"
	is_officer = TRUE
	is_commander = TRUE
	head_position = TRUE
	SL_check_independent = TRUE
...
/datum/job/soviet/partisan/commander/equip(var/mob/living/carbon/human/H)
	...
	H.add_note("Role", "You are a <b>[title]</b>, the leader of the Soviet partisan forces in the area. Protect your men and defeat the germans!")
	if (partisan_stockpile)
		H << "<br><span class = 'warning'>You have a stockpile of weapons at [partisan_stockpile.name]. Also, there are some stockpiles of medical items and tools around the town.</span>"
	H.setStat("strength", civ_stat())
	H.setStat("engineering", civ_stat())
