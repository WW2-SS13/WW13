...
/datum/chemical_reaction/inaprovaline
	...
	id = "inaprovaline"
	result = "inaprovaline"
	required_reagents = list("acetone" = TRUE, "carbon" = TRUE, "sugar" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/dylovene
	...
	id = "anti_toxin"
	result = "anti_toxin"
	required_reagents = list("silicon" = TRUE, "potassium" = TRUE, "ammonia" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/tramadol
	...
	id = "tramadol"
	result = "tramadol"
	required_reagents = list("inaprovaline" = TRUE, "ethanol" = TRUE, "acetone" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/paracetamol
	...
	id = "paracetamol"
	result = "paracetamol"
	required_reagents = list("tramadol" = TRUE, "sugar" = TRUE, "water" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/oxycodone
	...
	id = "oxycodone"
	result = "oxycodone"
	required_reagents = list("ethanol" = TRUE, "tramadol" = TRUE)
...
/datum/chemical_reaction/sterilizine
	...
	id = "sterilizine"
	result = "sterilizine"
	required_reagents = list("ethanol" = TRUE, "anti_toxin" = TRUE, "hclacid" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/silicate
	...
	id = "silicate"
	result = "silicate"
	required_reagents = list("aluminum" = TRUE, "silicon" = TRUE, "acetone" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/mutagen
	...
	id = "mutagen"
	result = "mutagen"
	required_reagents = list("radium" = TRUE, "phosphorus" = TRUE, "hclacid" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/space_drugs
	...
	id = "space_drugs"
	result = "space_drugs"
	required_reagents = list("mercury" = TRUE, "sugar" = TRUE, "lithium" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/pacid
	...
	id = "pacid"
	result = "pacid"
	required_reagents = list("sacid" = TRUE, "hclacid" = TRUE, "potassium" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/synaptizine
	...
	id = "synaptizine"
	result = "synaptizine"
	required_reagents = list("sugar" = TRUE, "lithium" = TRUE, "water" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/hyronalin
	...
	id = "hyronalin"
	result = "hyronalin"
	required_reagents = list("radium" = TRUE, "anti_toxin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/arithrazine
	...
	id = "arithrazine"
	result = "arithrazine"
	required_reagents = list("hyronalin" = TRUE, "hydrazine" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/impedrezene
	...
	id = "impedrezene"
	result = "impedrezene"
	required_reagents = list("mercury" = TRUE, "acetone" = TRUE, "sugar" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/kelotane
	...
	id = "kelotane"
	result = "kelotane"
	required_reagents = list("silicon" = TRUE, "carbon" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/virus_food
	...
	id = "virusfood"
	result = "virusfood"
	required_reagents = list("water" = TRUE, "milk" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/leporazine
	...
	id = "leporazine"
	result = "leporazine"
	required_reagents = list("silicon" = TRUE, "copper" = TRUE)
	catalysts = list("plasma" = 5)
	result_amount = 2
...
/datum/chemical_reaction/cryptobiolin
	...
	id = "cryptobiolin"
	result = "cryptobiolin"
	required_reagents = list("potassium" = TRUE, "acetone" = TRUE, "sugar" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/tricordrazine
	...
	required_reagents = list("inaprovaline" = TRUE, "anti_toxin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/alkysine
	...
	id = "alkysine"
	result = "alkysine"
	required_reagents = list("hclacid" = TRUE, "ammonia" = TRUE, "anti_toxin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/dexalin
	...
	catalysts = list("plasma" = TRUE)
	inhibitors = list("water" = TRUE) // Messes with cryox
	result_amount = TRUE
...
/datum/chemical_reaction/dermaline
	...
	id = "dermaline"
	result = "dermaline"
	required_reagents = list("acetone" = TRUE, "phosphorus" = TRUE, "kelotane" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/dexalinp
	...
	id = "dexalinp"
	result = "dexalinp"
	required_reagents = list("dexalin" = TRUE, "carbon" = TRUE, "iron" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/bicaridine
	...
	id = "bicaridine"
	result = "bicaridine"
	required_reagents = list("inaprovaline" = TRUE, "carbon" = TRUE)
	inhibitors = list("sugar" = TRUE) // Messes up with inaprovaline
	result_amount = 2
...
/datum/chemical_reaction/hyperzine
	...
	id = "hyperzine"
	result = "hyperzine"
	required_reagents = list("sugar" = TRUE, "phosphorus" = TRUE, "sulfur" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/ryetalyn
	...
	id = "ryetalyn"
	result = "ryetalyn"
	required_reagents = list("arithrazine" = TRUE, "carbon" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/cryoxadone
	...
	id = "cryoxadone"
	result = "cryoxadone"
	required_reagents = list("dexalin" = TRUE, "water" = TRUE, "acetone" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/clonexadone
	...
	id = "clonexadone"
	result = "clonexadone"
	required_reagents = list("cryoxadone" = TRUE, "sodium" = TRUE, "plasma" = 0.1)
	catalysts = list("plasma" = 5)
	result_amount = 2
...
/datum/chemical_reaction/imidazoline
	...
	id = "imidazoline"
	result = "imidazoline"
	required_reagents = list("carbon" = TRUE, "hydrazine" = TRUE, "anti_toxin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/ethylredoxrazine
	...
	required_reagents = list("acetone" = TRUE, "anti_toxin" = TRUE, "carbon" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/soporific
	...
	id = "stoxin"
	result = "stoxin"
	required_reagents = list("chloralhydrate" = TRUE, "sugar" = 4)
...
/datum/chemical_reaction/chloralhydrate
	...
	required_reagents = list("ethanol" = TRUE, "hclacid" = 3, "water" = TRUE)
	result_amount = TRUE
...
/datum/chemical_reaction/potassium_chloride
	...
	required_reagents = list("sodiumchloride" = TRUE, "potassium" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/potassium_chlorophoride
	...
	required_reagents = list("potassium_chloride" = TRUE, "plasma" = TRUE, "chloralhydrate" = TRUE)
	result_amount = 4
...
/datum/chemical_reaction/mindbreaker
	...
	id = "mindbreaker"
	result = "mindbreaker"
	required_reagents = list("silicon" = TRUE, "hydrazine" = TRUE, "anti_toxin" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/lipozine
	...
	id = "Lipozine"
	result = "lipozine"
	required_reagents = list("sodiumchloride" = TRUE, "ethanol" = TRUE, "radium" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/surfactant
	...
	id = "surfactant"
	result = "surfactant"
	required_reagents = list("hydrazine" = 2, "carbon" = 2, "sacid" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/diethylamine
	...
	id = "diethylamine"
	result = "diethylamine"
	required_reagents = list ("ammonia" = TRUE, "ethanol" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/space_cleaner
	...
	id = "cleaner"
	result = "cleaner"
	required_reagents = list("ammonia" = TRUE, "water" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/plantbgone
	...
	id = "plantbgone"
	result = "plantbgone"
	required_reagents = list("toxin" = TRUE, "water" = 4)
	result_amount = 5
...
/datum/chemical_reaction/foaming_agent
	...
	required_reagents = list("lithium" = TRUE, "hydrazine" = TRUE)
	result_amount = TRUE
...
/datum/chemical_reaction/glycerol
	...
	id = "glycerol"
	result = "glycerol"
	required_reagents = list("cornoil" = 3, "sacid" = TRUE)
	result_amount = TRUE
...
/datum/chemical_reaction/sodiumchloride
	...
	required_reagents = list("sodium" = TRUE, "hclacid" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/coolant
	...
	id = "coolant"
	result = "coolant"
	required_reagents = list("tungsten" = TRUE, "acetone" = TRUE, "water" = TRUE)
	result_amount = 3
	log_is_important = TRUE
...
/datum/chemical_reaction/rezadone
	...
	id = "rezadone"
	result = "rezadone"
	required_reagents = list("carpotoxin" = TRUE, "cryptobiolin" = TRUE, "copper" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/lexorin
	...
	id = "lexorin"
	result = "lexorin"
	required_reagents = list("plasma" = TRUE, "hydrazine" = TRUE, "ammonia" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/methylphenidate
	...
	required_reagents = list("mindbreaker" = TRUE, "hydrazine" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/citalopram
	...
	id = "citalopram"
	result = "citalopram"
	required_reagents = list("mindbreaker" = TRUE, "carbon" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/paroxetine
	...
	id = "paroxetine"
	result = "paroxetine"
	required_reagents = list("mindbreaker" = TRUE, "acetone" = TRUE, "inaprovaline" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/plastication
	...
	id = "solidplastic"
	result = null
	required_reagents = list("pacid" = TRUE, "plasticide" = 2)
	result_amount = TRUE
...
/datum/chemical_reaction/explosion_potassium
	...
	result = null
	required_reagents = list("water" = TRUE, "potassium" = TRUE)
	result_amount = 2
	mix_message = null
...
/datum/chemical_reaction/flash_powder
	...
	id = "flash_powder"
	result = null
	required_reagents = list("aluminum" = TRUE, "potassium" = TRUE, "sulfur" = TRUE )
	result_amount = null
...
/datum/chemical_reaction/emp_pulse
	...
	id = "emp_pulse"
	result = null
	required_reagents = list("uranium" = TRUE, "iron" = TRUE) // Yes, laugh, it's the best recipe I could think of that makes a little bit of sense
	result_amount = 2
...
/datum/chemical_reaction/nitroglycerin
	...
	required_reagents = list("glycerol" = TRUE, "pacid" = TRUE, "sacid" = TRUE)
	result_amount = 2
	log_is_important = TRUE
...
/datum/chemical_reaction/napalm
	...
	id = "napalm"
	result = null
	required_reagents = list("aluminum" = TRUE, "plasma" = TRUE, "sacid" = TRUE )
	result_amount = TRUE
...
/datum/chemical_reaction/chemsmoke
	...
	id = "chemsmoke"
	result = null
	required_reagents = list("potassium" = TRUE, "sugar" = TRUE, "phosphorus" = TRUE)
	result_amount = 0.4
...
/datum/chemical_reaction/foam
	...
	id = "foam"
	result = null
	required_reagents = list("surfactant" = TRUE, "water" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/metalfoam
	...
	id = "metalfoam"
	result = null
	required_reagents = list("aluminum" = 3, "foaming_agent" = TRUE, "pacid" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/ironfoam
	...
	id = "ironlfoam"
	result = null
	required_reagents = list("iron" = 3, "foaming_agent" = TRUE, "pacid" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/red_paint
	...
	id = "red_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_red" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/orange_paint
	...
	id = "orange_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_orange" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/yellow_paint
	...
	id = "yellow_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_yellow" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/green_paint
	...
	id = "green_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_green" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/blue_paint
	...
	id = "blue_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_blue" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/purple_paint
	...
	id = "purple_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_purple" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/grey_paint //mime
	...
	id = "grey_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_grey" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/brown_paint
	...
	id = "brown_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "crayon_dust_brown" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/blood_paint
	...
	id = "blood_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "blood" = 2)
	result_amount = 5
...
/datum/chemical_reaction/milk_paint
	...
	id = "milk_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "milk" = 5)
	result_amount = 5
...
/datum/chemical_reaction/orange_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "orangejuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/tomato_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "tomatojuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/lime_juice_paint
	...
	id = "lime_juice_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "limejuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/carrot_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "carrotjuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/berry_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "berryjuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/grape_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "grapejuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/poisonberry_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "poisonberryjuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/watermelon_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "watermelonjuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/lemon_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "lemonjuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/banana_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "banana" = 5)
	result_amount = 5
...
/datum/chemical_reaction/potato_juice_paint
	...
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "potatojuice" = 5)
	result_amount = 5
...
/datum/chemical_reaction/carbon_paint
	...
	id = "carbon_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "carbon" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/aluminum_paint
	...
	id = "aluminum_paint"
	result = "paint"
	required_reagents = list("plasticide" = TRUE, "water" = 3, "aluminum" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/slime/spawn
	...
	id = "m_spawn"
	result = null
	required_reagents = list("plasma" = TRUE)
	result_amount = TRUE
...
/datum/chemical_reaction/slime/bork/on_reaction(var/datum/reagents/holder)
	...
	for(var/i = TRUE, i <= 4 + rand(1,2), i++)
		var/chosen = pick(borks)
		var/obj/B = new chosen
		if(B)
			B.loc = get_turf(holder.my_atom)
			if(prob(50))
				for(var/j = TRUE, j <= rand(1, 3), j++)
...
/datum/chemical_reaction/slime/glow
	...
	id = "m_glow"
	result = null
	required_reagents = list("water" = TRUE)
	result_amount = TRUE
	required = /obj/item/slime_extract/yellow
...
/datum/chemical_reaction/slime/jam
	...
	id = "m_jam"
	result = "slimejelly"
	required_reagents = list("sugar" = TRUE)
	result_amount = 10
	required = /obj/item/slime_extract/purple
...
/datum/chemical_reaction/hot_coco
	...
	id = "hot_coco"
	result = "hot_coco"
	required_reagents = list("water" = 5, "coco" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/soysauce
	...
	id = "soysauce"
	result = "soysauce"
	required_reagents = list("soymilk" = 4, "sacid" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/ketchup
	...
	id = "ketchup"
	result = "ketchup"
	required_reagents = list("tomatojuice" = 2, "water" = TRUE, "sugar" = TRUE)
	result_amount = 4
...
/datum/chemical_reaction/syntiflesh
	...
	id = "syntiflesh"
	result = null
	required_reagents = list("blood" = 5, "clonexadone" = TRUE)
	result_amount = TRUE
...
/datum/chemical_reaction/hot_ramen
	...
	id = "hot_ramen"
	result = "hot_ramen"
	required_reagents = list("water" = TRUE, "dry_ramen" = 3)
	result_amount = 3
...
/datum/chemical_reaction/hell_ramen
	...
	id = "hell_ramen"
	result = "hell_ramen"
	required_reagents = list("capsaicin" = TRUE, "hot_ramen" = 6)
	result_amount = 6
...
/datum/chemical_reaction/goldschlager
	...
	id = "goldschlager"
	result = "goldschlager"
	required_reagents = list("vodka" = 10, "gold" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/patron
	...
	id = "patron"
	result = "patron"
	required_reagents = list("tequilla" = 10, "silver" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/bilk
	...
	id = "bilk"
	result = "bilk"
	required_reagents = list("milk" = TRUE, "beer" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/icetea
	...
	id = "icetea"
	result = "icetea"
	required_reagents = list("ice" = TRUE, "tea" = 2)
	result_amount = 3
...
/datum/chemical_reaction/icecoffee
	...
	id = "icecoffee"
	result = "icecoffee"
	required_reagents = list("ice" = TRUE, "coffee" = 2)
	result_amount = 3
...
/datum/chemical_reaction/nuka_cola
	...
	id = "nuka_cola"
	result = "nuka_cola"
	required_reagents = list("uranium" = TRUE, "cola" = 5)
	result_amount = 5
...
/datum/chemical_reaction/gin_tonic
	...
	id = "gintonic"
	result = "gintonic"
	required_reagents = list("gin" = 2, "tonic" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/cuba_libre
	...
	id = "cubalibre"
	result = "cubalibre"
	required_reagents = list("rum" = 2, "cola" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/martini
	...
	id = "martini"
	result = "martini"
	required_reagents = list("gin" = 2, "vermouth" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/vodkamartini
	...
	id = "vodkamartini"
	result = "vodkamartini"
	required_reagents = list("vodka" = 2, "vermouth" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/white_russian
	...
	id = "whiterussian"
	result = "whiterussian"
	required_reagents = list("blackrussian" = 2, "cream" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/whiskey_cola
	...
	id = "whiskeycola"
	result = "whiskeycola"
	required_reagents = list("whiskey" = 2, "cola" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/screwdriver
	...
	required_reagents = list("vodka" = 2, "orangejuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/bloody_mary
	...
	id = "bloodymary"
	result = "bloodymary"
	required_reagents = list("vodka" = 2, "tomatojuice" = 3, "limejuice" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/gargle_blaster
	...
	required_reagents = list("vodka" = 2, "gin" = TRUE, "whiskey" = TRUE, "cognac" = TRUE, "limejuice" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/brave_bull
	...
	id = "bravebull"
	result = "bravebull"
	required_reagents = list("tequilla" = 2, "kahlua" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/tequilla_sunrise
	...
	required_reagents = list("tequilla" = 2, "orangejuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/beepsky_smash
	...
	id = "beepksysmash"
	result = "beepskysmash"
	required_reagents = list("limejuice" = TRUE, "whiskey" = TRUE, "iron" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/doctor_delight
	...
	required_reagents = list("limejuice" = TRUE, "tomatojuice" = TRUE, "orangejuice" = TRUE, "cream" = 2, "tricordrazine" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/irish_cream
	...
	id = "irishcream"
	result = "irishcream"
	required_reagents = list("whiskey" = 2, "cream" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/manly_dorf
	...
	id = "manlydorf"
	result = "manlydorf"
	required_reagents = list ("beer" = TRUE, "ale" = 2)
	result_amount = 3
...
/datum/chemical_reaction/hooch
	...
	id = "hooch"
	result = "hooch"
	required_reagents = list ("sugar" = TRUE, "ethanol" = 2, "fuel" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/irish_coffee
	...
	id = "irishcoffee"
	result = "irishcoffee"
	required_reagents = list("irishcream" = TRUE, "coffee" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/b52
	...
	id = "b52"
	result = "b52"
	required_reagents = list("irishcream" = TRUE, "kahlua" = TRUE, "cognac" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/atomicbomb
	...
	id = "atomicbomb"
	result = "atomicbomb"
	required_reagents = list("b52" = 10, "uranium" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/margarita
	...
	id = "margarita"
	result = "margarita"
	required_reagents = list("tequilla" = 2, "limejuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/longislandicedtea
	...
	required_reagents = list("vodka" = TRUE, "gin" = TRUE, "tequilla" = TRUE, "cubalibre" = 3)
	result_amount = 6
...
/datum/chemical_reaction/threemileisland
	...
	required_reagents = list("longislandicedtea" = 10, "uranium" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/whiskeysoda
	...
	id = "whiskeysoda"
	result = "whiskeysoda"
	required_reagents = list("whiskey" = 2, "sodawater" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/black_russian
	...
	id = "blackrussian"
	result = "blackrussian"
	required_reagents = list("vodka" = 2, "kahlua" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/manhattan
	...
	id = "manhattan"
	result = "manhattan"
	required_reagents = list("whiskey" = 2, "vermouth" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/manhattan_proj
	...
	required_reagents = list("manhattan" = 10, "uranium" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/vodka_tonic
	...
	id = "vodkatonic"
	result = "vodkatonic"
	required_reagents = list("vodka" = 2, "tonic" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/gin_fizz
	...
	id = "ginfizz"
	result = "ginfizz"
	required_reagents = list("gin" = TRUE, "sodawater" = TRUE, "limejuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/bahama_mama
	...
	id = "bahama_mama"
	result = "bahama_mama"
	required_reagents = list("rum" = 2, "orangejuice" = 2, "limejuice" = TRUE, "ice" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/singulo
	...
	id = "singulo"
	result = "singulo"
	required_reagents = list("vodka" = 5, "radium" = TRUE, "wine" = 5)
	result_amount = 10
...
/datum/chemical_reaction/alliescocktail
	...
	required_reagents = list("classicmartini" = TRUE, "vodka" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/demonsblood
	...
	id = "demonsblood"
	result = "demonsblood"
	required_reagents = list("rum" = 3, "spacemountainwind" = TRUE, "blood" = TRUE, "dr_gibb" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/booger
	...
	id = "booger"
	result = "booger"
	required_reagents = list("cream" = 2, "banana" = TRUE, "rum" = TRUE, "watermelonjuice" = TRUE)
	result_amount = 5
...
/datum/chemical_reaction/antifreeze
	...
	id = "antifreeze"
	result = "antifreeze"
	required_reagents = list("vodka" = TRUE, "cream" = TRUE, "ice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/barefoot
	...
	id = "barefoot"
	result = "barefoot"
	required_reagents = list("berryjuice" = TRUE, "cream" = TRUE, "vermouth" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/grapesoda
	...
	id = "grapesoda"
	result = "grapesoda"
	required_reagents = list("grapejuice" = 2, "cola" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/sbiten
	...
	id = "sbiten"
	result = "sbiten"
	required_reagents = list("vodka" = 10, "capsaicin" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/red_mead
	...
	id = "red_mead"
	result = "red_mead"
	required_reagents = list("blood" = TRUE, "mead" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/mead
	...
	id = "mead"
	result = "mead"
	required_reagents = list("sugar" = TRUE, "water" = TRUE)
	catalysts = list("enzyme" = 5)
	result_amount = 2
...
/datum/chemical_reaction/iced_beer
	...
	id = "iced_beer"
	result = "iced_beer"
	required_reagents = list("beer" = 10, "frostoil" = TRUE)
	result_amount = 10
...
/datum/chemical_reaction/iced_beer2
	...
	id = "iced_beer"
	result = "iced_beer"
	required_reagents = list("beer" = 5, "ice" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/grog
	...
	id = "grog"
	result = "grog"
	required_reagents = list("rum" = TRUE, "water" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/soy_latte
	...
	id = "soy_latte"
	result = "soy_latte"
	required_reagents = list("coffee" = TRUE, "soymilk" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/cafe_latte
	...
	id = "cafe_latte"
	result = "cafe_latte"
	required_reagents = list("coffee" = TRUE, "milk" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/acidspit
	...
	id = "acidspit"
	result = "acidspit"
	required_reagents = list("sacid" = TRUE, "wine" = 5)
	result_amount = 6
...
/datum/chemical_reaction/amasec
	...
	id = "amasec"
	result = "amasec"
	required_reagents = list("iron" = TRUE, "wine" = 5, "vodka" = 5)
	result_amount = 10
...
/datum/chemical_reaction/changelingsting
	...
	required_reagents = list("screwdrivercocktail" = TRUE, "limejuice" = TRUE, "lemonjuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/aloe
	...
	id = "aloe"
	result = "aloe"
	required_reagents = list("cream" = TRUE, "whiskey" = TRUE, "watermelonjuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/andalusia
	...
	id = "andalusia"
	result = "andalusia"
	required_reagents = list("rum" = TRUE, "whiskey" = TRUE, "lemonjuice" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/neurotoxin
	...
	id = "neurotoxin"
	result = "neurotoxin"
	required_reagents = list("gargleblaster" = TRUE, "stoxin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/snowwhite
	...
	id = "snowwhite"
	result = "snowwhite"
	required_reagents = list("beer" = TRUE, "lemon_lime" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/irishcarbomb
	...
	id = "irishcarbomb"
	result = "irishcarbomb"
	required_reagents = list("ale" = TRUE, "irishcream" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/syndicatebomb
	...
	required_reagents = list("beer" = TRUE, "whiskeycola" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/erikasurprise
	...
	required_reagents = list("ale" = 2, "limejuice" = TRUE, "whiskey" = TRUE, "banana" = TRUE, "ice" = TRUE)
	result_amount = 6
...
/datum/chemical_reaction/devilskiss
	...
	id = "devilskiss"
	result = "devilskiss"
	required_reagents = list("blood" = TRUE, "kahlua" = TRUE, "rum" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/hippiesdelight
	...
	required_reagents = list("psilocybin" = TRUE, "gargleblaster" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/bananahonk
	...
	id = "bananahonk"
	result = "bananahonk"
	required_reagents = list("banana" = TRUE, "cream" = TRUE, "sugar" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/silencer
	...
	id = "silencer"
	result = "silencer"
	required_reagents = list("nothing" = TRUE, "cream" = TRUE, "sugar" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/driestmartini
	...
	required_reagents = list("nothing" = TRUE, "gin" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/lemonade
	...
	id = "lemonade"
	result = "lemonade"
	required_reagents = list("lemonjuice" = TRUE, "sugar" = TRUE, "water" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/kiraspecial
	...
	id = "kiraspecial"
	result = "kiraspecial"
	required_reagents = list("orangejuice" = TRUE, "limejuice" = TRUE, "sodawater" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/brownstar
	...
	id = "brownstar"
	result = "brownstar"
	required_reagents = list("orangejuice" = 2, "cola" = TRUE)
	result_amount = 3
...
/datum/chemical_reaction/milkshake
	...
	id = "milkshake"
	result = "milkshake"
	required_reagents = list("cream" = TRUE, "ice" = 2, "milk" = 2)
	result_amount = 5
...
/datum/chemical_reaction/rewriter
	...
	id = "rewriter"
	result = "rewriter"
	required_reagents = list("spacemountainwind" = TRUE, "coffee" = TRUE)
	result_amount = 2
...
/datum/chemical_reaction/suidream
	...
	id = "suidream"
	result = "suidream"
	required_reagents = list("space_up" = TRUE, "bluecuracao" = TRUE, "melonliquor" = TRUE)
	result_amount = 3
