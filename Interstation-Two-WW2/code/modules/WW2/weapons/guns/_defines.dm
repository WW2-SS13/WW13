...
#define DEFAULT_PTRD_ACCURACY -4
#define DEFAULT_PTRD_SCOPED_ACCURACY -3

#define DEFAULT_PISTOL_ACCURACY FALSE
#define DEFAULT_PISTOL_SCOPED_ACCURACY 2

#define DEFAULT_BOLTACTION_ACCURACY TRUE
#define DEFAULT_BOLTACTION_SCOPED_ACCURACY 3

#define DEFAULT_SEMIAUTO_ACCURACY FALSE
#define DEFAULT_SEMIAUTO_SCOPED_ACCURACY TRUE