...
/obj/item/projectile/forcebolt/on_hit(var/atom/movable/target, var/blocked = FALSE)
	if(istype(target))
...
/*
/obj/item/projectile/forcebolt/strong/on_hit(var/atom/target, var/blocked = FALSE)
