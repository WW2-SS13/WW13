...
/turf/proc/create_fire(fl, var/last_a_bit = 0)
	return 0

/turf/simulated/create_fire(fl, var/last_a_bit = 0)
...
/obj/fire
	...
	var/sustains_self_temporarily = 0
...
/obj/fire/New(newLoc,fl, sustain = 0)
	..()

	sustains_self_temporarily = sustain
